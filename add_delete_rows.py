...
def item_row(item_num):
    ...
    :return:         List
    """
    row =  [sg.pin(sg.Col([[sg.B(sg.SYMBOL_X_SMALL, border_width=0, button_color=(sg.theme_text_color(), sg.theme_background_color()), k=('-DEL-', item_num), tooltip='Delete this item'),
...
def make_window():
    ...
    layout = [  [sg.Text('Add and "Delete" Rows From a Window', font='_ 15')],
                ...
                [sg.T(sg.SYMBOL_X_SMALL, enable_events=True, k='Exit', tooltip='Exit Application'), sg.T('↻', enable_events=True, k='Refresh',  tooltip='Save Changes & Refresh'), sg.T('+', enable_events=True, k='Add Item', tooltip='Add Another Item')]]
